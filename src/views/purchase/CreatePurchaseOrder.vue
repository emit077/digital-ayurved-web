  ...
  <div>
    <v-form ref="purchase_order_form" v-model="valid" lazy-validation>
      ...
      <!-- <div class="border py-3 mt-3">
        <v-row
          v-for="(item, i) in order_item_list"
          :key="i"
          justify="start"
          no-gutters=""
          class=""
        >
          <v-col
            ...
            cols="10"
            md="3"
            :class="!$vuetify.display.mobile ? 'pl-4 pr-2' : ''"
          >
          ...
          <v-col
            ...
            cols="10"
            md="2"
            :class="!$vuetify.display.mobile ? 'px-2' : ''"
          >
            <label class="ml-1">{{ $lang.EXPIRY_DATE }}</label>
            <v-text-field
          ...
          <v-col
            ...
            :class="!$vuetify.display.mobile ? 'px-2' : ''"
          >
            <label class="ml-1">{{ $lang.UNIT_PRICE }}</label>
            <v-text-field
...
export default defineComponent({
  ...
  methods: {
    ...
    async createPurchaseOrder() {
      ...
      form.append("vendor_table_id", this.vendor.id);
